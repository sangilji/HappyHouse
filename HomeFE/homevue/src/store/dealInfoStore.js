import { sidoList,gugunList,dongList,getHouseList,houseDeal } from "@/api/item/item";
...
const dealInfoStore = {
  ...
  actions: {
    ...
    async getDealInfo({commit,state}){
        await houseDeal(state.houseList[state.currentIndex].aptCode,
            ({data}) =>{
