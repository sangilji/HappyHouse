        ...
        <div class="modal-body">
          <div>
            ...
            <div class="input-group pb-3">
              <input
                ...
                placeholder="건물명 / 동"
              />
              <button @click="onBtnClick" class="btn btn-primary d-inline-block" type="button">
          ...
          >
            ...
            >
              ...
              <i
                @click="selectHouse(house.houseNo, house.aptName)"
...
export default {
  ...
  methods: {
    ...
    searchHouse() {
      http
        .get(`/house/detail/keyword/${this.inputKeyword}`)
        .then(({ data }) => {
          console.log(data);
